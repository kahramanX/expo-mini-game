    ...
    >
      <SafeAreaView style={{ flex: 1 }} edges={["top", "bottom"]}>
        <View className="flex-1 justify-start items-center px-4">
          <View className="h-60  w-full justify-center items-center px-4 rounded-lg bg-purple-900/80 border-2 border-purple-400/30 shadow-2xl">
            ...
            <View className="flex-row w-full gap-2">
              ...
              <View className="flex-1">
                <PrimaryButton onPress={numberInputHandler}>
                  Confirm
                </PrimaryButton>
              </View>
            </View>
